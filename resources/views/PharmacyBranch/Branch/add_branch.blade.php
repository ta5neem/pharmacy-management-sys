        ...
        <div class="add-branch">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form action="/branchs/store" method="POST">
                                    @csrf

                                <div class="form-row" style="margin-top: 30px;">
                                    <label for="name" class="col-lg-2 label-input">Name:</label>
                                    <input type="text" class="form-control2 col-lg-9" id="name" placeholder="Name"
                                        name="name" required>
                                </div>

                                <div class="form-row">
                                    <label for="email" class="col-lg-2 label-input">E-mail:</label>
                                    <input type="email" class="form-control2 col-lg-9" id="email" placeholder="E-mail"
                                        name="email" required>
                                </div>
