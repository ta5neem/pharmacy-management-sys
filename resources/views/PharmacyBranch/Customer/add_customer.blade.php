        ...
        <div class="add-customer">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form class="needs-validation" action="/Customer/store" method="POST" novalidate>
                                    @csrf
                                ...
                                <div class="col">
                                    <input type="text" class="form-control input" minlength="10"
                                ...
                                <button type="submit"  href="/Customer/store" class="btn btn-list float-right">Add</button>
                            </form>
