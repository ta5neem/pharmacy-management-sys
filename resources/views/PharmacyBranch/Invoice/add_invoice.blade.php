 ...
 @include('sidebar&navbar')
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between bd-highlight mb-3">
                    ...
                    <div class="p-2 bd-highlight">
                        ...
                        <a href="invoice_list.html"><button type="button" class="btn btn-list"><i
                                    class="fa fa-align-justify"></i> &nbsp;Invoice List</button></a>
                    </div>
                </div>
                <div class="card-body">
                    <form class="form"  action="/Invoice/store" method="POST">
                        @csrf
                        <div class="form-row">
                            ...
                            <select class="selectpicker col-lg-3 select-customer" data-live-search="true"
                                id="select-customer" onchange="doSomething();"  name="customer_name">
                                <option data-value="Choose" selected>Choose</option>
                                @foreach($customers as $one)
                                <option data-value="{{$one->id}}">{{$one->name}}{{$one->mobile}}</option>
                              @endforeach
                            </select>
                   ...
                   <!--      <div class="form-row">
                            <label for="InvoiceID" class="col-lg-2 label-input">Phone:</label>
                            <input type="text" class="form-control2  col-lg-3" id="InvoiceID"
                             class="phone" id="phone" name="phone">

                             <div class="phone-customer" id="phone-customer" style="display: none;">0932950380</div>
    ...
    <div class="form-row">
                                    <div class="col-lg-9">
                                        ...
                                        <label class="col-lg-4 container">pay by stripe
                ...
                for (var i=0; i<products.length; i++){
                    $('#invoice_details').find('tbody').append($('' + 
                        '<tr class="cloning-row" id="' + i + '">' +
                            '<td><input type="text" name="product_name[0]" id="product_name" class="product_name readonly" readonly="readonly" style="width: 100%;" value="'+products[i].name_product+'"></td>'+

                            '<td><input type="number" class="avail_qty readonly" style="width: 100%;" name="avail_qty[0]" id="avail_qty" readonly="readonly" value="'+products[i].quantity_product+'"></td>' +

                            '<td><input type="text" class="expiry_date readonly" id="expiry_date" readonly="readonly" style="width: 100%;" name="expiry_date[0]" value="'+products[i].expiry_product+'"></td>'+

                            '<td><input type="number" required name="quantity[0]" id="quantity" class="quantity" style="width: 100%;" value="'+products[i].quantity+'"></td>'+

                            '<td><input type="number" class="price readonly" style="width: 100%;" name="price[0]" id="price" readonly="readonly" value="'+products[i].price_product+'"> </td>'+

                            '<td><input type="number" style="width: 100%;" name="discount[0]" class="discount" id="discount" min="0"></td>'+

                            '<td><input type="number" class="total readonly" readonly="readonly" name="total[0]" id="total" style="width: 100%;"></td>'+
