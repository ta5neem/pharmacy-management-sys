    ...
    <div class="body-page" id="body-page">
        <div class="invoice-report">
            <div class="card">
                ...
                <form action="/Invoice/All/report" method="GET">
    ...
    @csrf
                    ...
                    <div class="row row-filter">
                        <div class="btn-group dropdown">
                            ...
                            <div class="dropdown-menu">
                                 <div class="list-group">
                                    ...
                                    <a href="/Invoice/Branch/report/{{$one->id}}"
                        ...
                        <div class="btn-group dropdown">
                            ...
                            <div class="dropdown-menu">
                                <div class="list-group">
                                    <a href="/Invoice/All/report"
                                        class="list-group-item list-group-item-action list-group-item-invoice"><i
                                            class="fa fa-money" ></i>All</a>
                                    <a href="/DelayedInvoice/All/report"
                                        class="list-group-item list-group-item-action list-group-item-invoice"><i
                                            class="fa fa-money"></i>Postpaid invoice</a>
                                                   <a href="/AnnualInvoice/report"
                                        class="list-group-item list-group-item-action list-group-item-invoice"><i
                                            class="fa fa-money"></i>Annual invoice</a>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-lg-5 col-md-12">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text total-span" id="basic-addon1">Total value
                                                    paid of invoices:</span>
                                            </div>
                <input class="form-control read" readonly value="{{$invoices->sum('paid')}}">
                                        </div>
                                    </div>
                                    <div class="col-lg-1"></div>
                                    <div class="col-lg-5 col-md-12">
