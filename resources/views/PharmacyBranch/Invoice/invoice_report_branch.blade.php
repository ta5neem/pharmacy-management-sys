            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        Invoices Report in Branch 
                    </div>
                </div>
                <div class="card-body">

                      <form action="/Invoice/Branch/report/{{ count($invoices)>0?$invoices->first()->branch_id : 0 }}" method="GET">
                            ...
                            <div class="dropdown-menu">
                                <div class="list-group">
                                    ...
                                    <a href="invoice_list_in_branch.html"
                                        class="list-group-item list-group-item-action list-group-item-invoice"><i
                                            class="fas fa-code-branch"></i>Branch 2</a>
                                </div>
