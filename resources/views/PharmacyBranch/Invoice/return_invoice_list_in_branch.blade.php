        ...
        <div class="invoice-list">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="/ReturnInvoice/Branch/list/{{ count($invoices)>0?$invoices->first()->branch_id : 0 }}" method="GET">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <a href="display_invoice.html" title="Display"><i class="fa fa-eye"></i></a>
                                        <a href="/Invoice/return_invoice/{{$invoice->id}}" title="Print"><i class="fa fa-print"></i></a>
                                    </div>
                                </td>
                            </tr>
                                                                @endforeach
