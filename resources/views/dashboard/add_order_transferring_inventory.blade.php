...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/add_order_transferring_inventory.css')}}">
...
<body>
   ...
   @include('sidebar&navbar')
    ...
    <div class="body-page" id="body-page">
        <div class="add-order-transferring-inventory">
            <div class="card">
                <div class="card-header d-flex justify-content-between bd-highlight mb-3">
                    <div class="p-2 bd-highlight">
                        Add Order Transferring Inventory
                    </div>
                    <div class="p-2 bd-highlight">
                        <a href="/orders/invevtory/all"><button type="button" class="btn btn-list"><i
                                    class="fa fa-plus-square-o"></i> &nbsp;Inventory Order List</button></a>
                    </div>
                </div>
                <div class="card-body">
                  <form id="form" action="/inven_orders/store" method="POST">

                         {{ csrf_field() }}
                        <div class="form-row">
                          <label for="warehouse_name" class="col-lg-2 label-input">From Inventory<i
                                  class="text-danger">
                                  * </i>:</label>
                          <select class="selectpicker col-lg-3 warehouse_name" name="warehouse_id"
                           ...
                           <option value="{{$one->name}}">{{$one->name}}</option>
                            ...
                            <input type="text" name="to_inventory"    value="{{\App\User::join('branches','branches.id','users.branch_id')->value('branches.name')}}"class="form-control2  col-lg-3 readonly" id="to_inventory" readonly>
                        ...
                        <div class="form-row">
                            ...
                            <input class="form-control2 col-lg-3" id="Date" name="order_date" data-provide="datepicker"
                                ...
                                <div class="col-lg-1"></div>
                                <label for="user_id" class="col-lg-2 label-input">User Name:</label>
                                <input type="text" name="User_name"    value="{{\App\User::select('name')->where('id',$user)->value('name')}}"class="form-control2  col-lg-3 readonly" id="to_inventory" readonly>
                            ...
                            <table class="table table-bordered table-invoice text-nowrap custom-table"
                                ...
                                <tbody>
                                    <tr class="cloning-row" id="0">
                                        ...
                                        <td><input type="number" required="required" name="quantity[{{0}}]" id="quantity" class="quantity" style="width: 100%;"></td>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"> <a class="btn-add"><i class="fa fa-plus" aria-hidden="true"></i></a> </td>
                                    </tr>
