        ...
        <div class="display-ordered-products">
            <div class="card">
                <div class="card-header d-flex justify-content-between bd-highlight mb-3">
                    ...
                    <div class="p-2 bd-highlight">
                        <a href="/orders/warhouse/all"><button type="button" class="btn btn-list"><i class="fa fa-align-justify"></i> &nbsp;Warehouse Order List</button></a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                          @foreach ($buyproduct as $one )
                            ...
                            <tr>
                                ...
                                <td>{{\App\Models\BuyOrder::where('id',$one->buy_order_id)->value('order_date')}}</td>
