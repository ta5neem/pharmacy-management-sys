...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/inventory_order_list.css')}}">
    ...
    <div class="body-page" id="body-page">
        <div class="inventory-order-list">
            <div class="card">
                ...
                <div class="card-body">
                  <form action="/order/Transfer/Search" method="POST" role="search" autocomplete="off">
                       {{ csrf_field() }}
                    <div class="row form-search-date">
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control search-date" name="start_at" placeholder="Start Date"
                              ...
                              <td>{{\App\Models\Warehouse::select('name')->where('id',$one->warehouse_id)->value('name')}}</td>
                                <td>
                                  <div class="row">
                                      ...
                                      <a href="/orders/delete/{{$one->id}}}" title="Cancelling Order"><i class="fas fa-undo"></i></a>
                                      <a href="/order/products/{{$one->id}}" title="Ordered products"><i class="fas fa-cart-arrow-down" aria-hidden="true"></i></a>
                                      <a href="/order/reciev/{{$one->id}}" title="Receipt the order"><i class="fas fa-receipt"></i></a>
                                  </div>
                                </td>
                            </tr>
                            @endforeach
