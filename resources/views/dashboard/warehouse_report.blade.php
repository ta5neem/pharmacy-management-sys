...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/warehouse_report.css')}}">
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control search-date" placeholder="Start Date"
                                    aria-describedby="basic-addon1" data-provide="datepicker" name="start">
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-12">
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control search-date" placeholder="End Date"
                                    aria-describedby="basic-addon1" data-provide="datepicker" name="end">
                        ...
                        <div class="btn-group dropdown">
                            ...
                            <div class="dropdown-menu">
                                <div class="list-group">
                                    <a href="\active\ware"
                                        class="list-group-item list-group-item-action list-group-item-invoice">Active warehouse</a>
                                    <a href="\inactive\ware"
                                        class="list-group-item list-group-item-action list-group-item-invoice">Inactive warehouse</a>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-lg-5 col-md-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control read" readonly value="{{$num_ware}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-5 col-md-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control read" readonly value="{{$order_num}}">
                                        </div>
                                    </div>
                                </div>
                            </form>
