            ...
            <div class="card-body">
                <table id="table" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <a href="{{asset('cosmeticProduct/edit/'. $cosmeticProduct -> id)}}"><i class="fas fa-edit" title="Edit"></i></a>
                                <a href="{{asset('cosmeticProduct/delete/'. $cosmeticProduct -> id)}}"><i class="fa fa-trash" title="Delete"></i></a>
                                <a href="{{asset('cosmeticProduct/show_batch/'. $cosmeticProduct -> id)}}" title="Display cosmetic product batches"><i class="fas fa-clone"></i></a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
