            ...
            <div class="card">
                <div class="card-header  d-flex justify-content-between bd-highlight mb-3">
                    <div class="p-2 bd-highlight">
                       Detail's Cosmetic Product
                    </div>
                    <div class="p-2 bd-highlight">
                        <a href="/cosmeticProduct/cosmetic_grid"><button type="button" class="btn btn-list"><i class="	fa fa-th"></i> &nbsp;Grid View</button></a>
                        <a href="/cosmeticProduct/create"><button type="button" class="btn btn-list"><i class="fa fa-plus-square-o"></i> &nbsp;Add cosmetic Product</button></a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="" style="margin-left: 60px; margin-top: 20px; ">
                            <div class="row-details">
                                ...
                                <label> Cosmetic Product Name:
                                    <label class="value">{{$detail -> name}}</label>
                                </label>
                                <br>
                            </div>
                            ...
                            <div class="row-details">
                                <i class="fa fa-chevron-circle-right"></i>
                                <label> &nbsp;Ingredients:
                                    <label class="value">{{$detail -> ingredients}}</label>
                                </label>
                                <br>
                            </div>
                            ...
                            <div class="row-details">
                                <i class="fa fa-chevron-circle-right"></i>
                                <label> &nbsp;Description:
                                    <label class="value">{{$detail -> description}}</label>
                                </label>
                                <br>
                            </div>
