        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="/effectiveMaterial/all"><button type="button" class="btn btn-list">
                            <i class="fa fa-align-justify"></i>&nbsp; Effective Material List</button>
                    </a>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        <form method="POST" action="{{route('effectiveMaterial.store')}}">
                            @csrf
                            <div class="col">
                                <input type="text" class="form-control input" name="name" required value="{{$effectiveMaterial -> name}}">
                                @error('name')
