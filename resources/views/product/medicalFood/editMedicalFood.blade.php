    ...
    <div class="add-medicalFood">
        <div class="card">
            <div class="card-header d-flex justify-content-between bd-highlight mb-3">
                ...
                <div class="p-2 bd-highlight">
                    <a href="/medicalFood/all"><button type="button" class="btn btn-list"><i class="fa fa-align-justify"></i> &nbsp;Medical Food List</button></a>
                </div>
            </div>
            <div class="card-body">
                ...
                <form method="POST" action="{{route('medicalFood.update', $medicalFood->id)}}"  enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <label for="FoodName" class="col-lg-2 label-input">Name <i
                                class="text-danger"> * </i>:</label>
                        <input type="text" class="form-control col-lg-3" id="FoodName"
                               value="{{$medicalFood->name}}" name="name" required>

                        <div class="col-lg-1"></div>

                        <label for="Manufacturer" class="col-lg-2 label-input">Manufacturer:</label>
                        <input type="text" name="manufacturer_company" class="form-control  col-lg-3" id="Manufacturer"
                               value="{{$medicalFood -> product ->manufacturer_company}}">
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" class="form-control col-lg-3" id="ProductCountry"
                               value="{{$medicalFood -> product -> product_country}}" name="product_country">
                        <div class="col-lg-1"></div>
                    ...
                    <div class="form-row">
                        <label for="Storage" class="col-lg-2 label-input">Storage <i
                                class="text-danger"> * </i>:</label>
                        <input type="text" class="form-control col-lg-3" id="Storage"
                               value="{{$medicalFood->storage}}" name="storage" required>

                        <div class="col-lg-1"></div>

                        <label for="AdverseEffects" class="col-lg-2 label-input">Adverse Effects:</label>
                        <input type="text" name="adverse_effects" class="form-control  col-lg-3" id="Adverse Effects"
                               value="{{$medicalFood->adverse_effects}}">
                    </div>
