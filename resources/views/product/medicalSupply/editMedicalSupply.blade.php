    ...
    <div class="add-medicalDevices">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{route('medicalSupply.update', $medicalSupply -> id)}}"  enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <label for="DeviceName" class="col-lg-2 label-input">Name <i class="text-danger"> *
                            </i>:</label>
                        <input type="text" class="form-control col-lg-3" id="DeviceName" value="{{$medicalSupply->name}}"
                               required name="name">
                        ...
                        <input type="text" class="form-control  col-lg-3" id="Manufacturer"
                               value="{{$medicalSupply-> product -> manufacturer_company}}" name="manufacturer_company">
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" class="form-control col-lg-3" id="ProductCountry"
                               value="{{$medicalSupply-> product -> product_country}}" name="product_country">

                        <div class="col-lg-1"></div>
                        <label for="bar_code" class="col-lg-2 label-input">Bar Code:</label>
                        <input type="text" class="form-control  col-lg-3"  name="bar_code" id="bar_code" value="{{$medicalSupply-> product -> bar_code}}">
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" class="form-control  col-lg-3"  name="use_to" id="use_to" value="{{$medicalSupply -> use_to}}">

                        <div class="col-lg-1"></div>

                        <label class="col-lg-2 label-input">Image:</label>
                        <input type="file" class="form-control col-lg-3" id="image" value="{{$medicalSupply -> product -> image}}" hidden name="image" >
