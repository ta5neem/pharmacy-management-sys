            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between bd-highlight mb-3">
                    <div class="p-2 bd-highlight">
                        Display Medical Supply's batches
                    </div>
{{--                    <div class="p-2 bd-highlight">--}}
{{--                        <a href="medicine_grid.html"><button type="button" class="btn btn-list"><i class="	fa fa-th"></i> &nbsp;Grid View</button></a>--}}
{{--                        <a href="medicine_list.html"><button type="button" class="btn btn-list"><i class="	fa fa-list-ul"></i> &nbsp;List View</button></a>--}}
{{--                    </div>--}}
                </div>
                <div class="card-body">
                    <table id="table" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        @foreach($batches as $batch)
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <a href="{{asset('medicalSupply/show_details/'. $batch ->id)}}" title="Display"><i class="fas fa-expand-arrows-alt"></i></a>
                                    </div>
                                </td>
