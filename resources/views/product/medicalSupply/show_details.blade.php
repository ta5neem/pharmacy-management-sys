            ...
            <div class="card">
                <div class="card-header  d-flex justify-content-between bd-highlight mb-3">
                    <div class="p-2 bd-highlight">
                       Detail's Medical Supply
                    </div>
                    <div class="p-2 bd-highlight">
                        <a href="/medicalSupply/supply_grid"><button type="button" class="btn btn-list"><i class="	fa fa-th"></i> &nbsp;Grid View</button></a>
                        <a href="/medicalSupply/create"><button type="button" class="btn btn-list"><i class="fa fa-plus-square-o"></i> &nbsp;Add Medical Supply</button></a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="" style="margin-left: 60px; margin-top: 20px; ">
                            ...
                            <div class="row-details">
                                <i class="fa fa-chevron-circle-right"></i>
                                <label> &nbsp;Use To:
                                    <label class="value">{{$detail -> use_to}}</label>
                                </label>
                                <br>
                            </div>
