    ...
    <div class="medicine-list">
        <div class="card">
            <div class="card-header d-flex justify-content-between bd-highlight mb-3">
                ...
                <div class="p-2 bd-highlight">
                    <a href="{{asset('/medicine/medicine_grid')}}"><button type="button" class="btn btn-list"><i class="	fa fa-th"></i> &nbsp;Grid View</button></a>
            ...
            <div class="card-body">
                <table id="table" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th scope="col">AEffective Material</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                ...
                                <a href="{{asset('medicine/show_batch/'. $medicine -> id)}}" title="Display medicine batches"><i class="fas fa-clone"></i></a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
