            ...
            <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="col-lg-5 col-md-12">
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control read" readonly value="{{$cosmeticProducts->groupBy('name')->count()}}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control read" readonly value="{{$cosmeticProducts->count()}}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table id="table1" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    @foreach($cosmeticProducts as  $cosmeticProduct)
                        <tr>
                            <td>{{$cosmeticProduct -> id}}</td>
                            <td>{{$cosmeticProduct -> name}}</td>
                            <td>{{$cosmeticProduct -> amount}}</td>
                            <td>{{$cosmeticProduct -> expired_date}}</td>
                            <td>{{$cosmeticProduct -> name_warehouse}}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
