                    ...
                    <div class="form-row">
                        <div class="col-lg-5 col-md-12">
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control read" readonly value="{{$medicines->groupBy('generic_name')->count()}}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control read" readonly value="{{$medicines->count()}}">
                            </div>
                        </div>
                    </div>
                </div>
