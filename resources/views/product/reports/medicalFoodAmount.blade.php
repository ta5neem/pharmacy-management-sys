        ...
        <div class="card">
            ...
            <div class="card-body">
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="input-group ">
                                <div class="input-group-prepend">
                                    <span class="input-group-text total-span" id="basic-addon1">Total number of medical food:</span>
                                </div>
                                <input class="form-control read col-md-2" readonly value="{{$medicalFoods->count()}}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table id="table1" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <thead>
                    <tr>
                        <th scope="col">Medical Food Id</th>
                    ...
                    @foreach($medicalFoods as $id => $medicalFood)
                        <tr>
                            ...
                            @foreach($medicalFood as $one)
                                <td>{{$one->name}}</td>
                                <td>{{$medicalFood ->count()}}</td>
                                @break
                            @endforeach
                            <td>{{$medicalFood->sum('amount')}}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
