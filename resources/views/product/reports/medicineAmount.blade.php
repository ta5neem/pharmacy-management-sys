                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="input-group ">
                                <div class="input-group-prepend">
                                    <span class="input-group-text total-span" id="basic-addon1">Total number of medicine:</span>
                                </div>
                                <input class="form-control read col-md-2" readonly value="{{$medicines->count()}}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table id="table1" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        @foreach($medicine as $one)
                            <td>{{$one->generic_name}}</td>
                            <td>{{$medicine ->count()}}</td>
                            @break
                        @endforeach
                        <td>{{$medicine->sum('amount')}}</td>
                    </tr>
                    @endforeach
                    </tbody>
                </table>
...
<script src="j{{asset('js/themes.js')}}"></script>
