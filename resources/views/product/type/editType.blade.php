    ...
    <div class="add-type">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6 ">
                        <form class="needs-validation" novalidate method="POST" action="{{route('type.update', $type -> id)}}">
                            @csrf
                            <div class="col">
                                <input type="text" class="form-control input" name="name_type" required value="{{$type -> name_type}}">
                                @error('name_type')
